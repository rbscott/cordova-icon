...
settings.OUTPUT_PATH = argv["output-path"]
settings.PROJECT_NAME = argv["project-name"]
...
var getPlatforms = function() {
  ...
  var projectName = settings.PROJECT_NAME

  platforms.push({
    name: "ios",
    // TODO: use async fs.exists
    isAdded: fs.existsSync(path.join(settings.OUTPUT_PATH, "ios")),
    iconsPath: path.join(settings.OUTPUT_PATH, "ios", projectName, xcodeFolder),
    icons: [
  ...
  platforms.push({
    name: "android",
    isAdded: fs.existsSync(path.join(settings.OUTPUT_PATH, "android")),
    iconsPath: path.join(settings.OUTPUT_PATH, "android/app/src/main/res/"),
    icons: [
  ...
  platforms.push({
    name: "osx",
    // TODO: use async fs.exists
    isAdded: fs.existsSync(path.join(settings.OUTPUT_PATH, "osx")),
    iconsPath: path.join(settings.OUTPUT_PATH, "osx", projectName, xcodeFolder),
    icons: [
  ...
  platforms.push({
    name: "windows",
    isAdded: fs.existsSync(path.join(settings.OUTPUT_PATH, "windows")),
    iconsPath: path.join(settings.OUTPUT_PATH, "windows/images/"),
    icons: [
